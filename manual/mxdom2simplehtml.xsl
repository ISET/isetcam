...
html body { height:100%; margin:0px; font-family:Georgia, Helvetica, sans-serif; font-size:12px; color:#000; line-height:140%; background:#fff none; overflow-y:scroll; }
