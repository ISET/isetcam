...
if ieNotDefined('pupilRadius'), p = 0.0015;
else p = pupilRadius;
end % Default pupil radius is 3mm
if ieNotDefined('dioptricPower'), D0 = 59.9404;
else D0 = dioptricPower;
end % dioptric power of unaccomodated eye
