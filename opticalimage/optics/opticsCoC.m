...
% Calculate the circle of confusion on the sensor surface given the optics
%   
%    circ = opticsCoC(optics, oDist, [unit='m'])
%
% The computed blur circle is for an object at a distance oDist on the
% surface of a sensor positioned at the focal distance from the lens.  This
% calculation is an approximation for a thin lens.
%
% We only use geometry to compute the circle.
%
