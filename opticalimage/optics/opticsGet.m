...
switch parm
    ...
    case {'imageheight'}
        ...
        if isempty(varargin), disp('fov required.');
            return;
        else
            fov = varargin{1};
    ...
    case {'otf', 'otfdata', 'optical transfer function'}
        ...
        switch lower(opticsModel)
            case 'diffractionlimited'
                ...
                if length(varargin) < 3, thisWave = [];
                else, thisWave = varargin{3};
                end
            ...
            case 'raytrace'
                ...
                case {'dlfsupport', 'dlfsupportmatrix'}
                    ...
                    if length(varargin) < 3, nSamp = 30;
                    else, nSamp = varargin{3};
                    end
