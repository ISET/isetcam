...
if isempty(rt)
    ...
    ieInWindowMessage('No ray trace data in optics.', hndl);
    return;
end
...
switch lower(dataType)
    ...
    case {'psf', 'pointspread', 'psfsurfacegraph'}
        ...
        if length(varargin) < 2
            ...
            if isempty(answer), disp('User canceled');
                return;
            else
    ...
    case {'otf', 'opticaltransferfunction'}
        ...
        xlabel('Frequency (c/mm)');
        ylabel('Frequency (c/mm)');
        str = sprintf('OTF %.0f at %.1f mm', w, fh);
        title(str);
    ...
    case {'otf550', 'opticaltransferfunction550'}
        ...
        xlabel('Frequency (c/mm)');
        ylabel('Frequency (c/mm)');
        str = sprintf('OTF 550nm at center');
        title(str);
