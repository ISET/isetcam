function [middleM,center] = getMiddleMatrix(m,sz)
%Extract values near middle of a matrix.
%
%   [middleM,center] = getMiddleMatrix(m,sz)
%
% Brief
...
[~,center] = getMiddleMatrix(sceneGet(scene,'photons'),sz)
%}
%{
