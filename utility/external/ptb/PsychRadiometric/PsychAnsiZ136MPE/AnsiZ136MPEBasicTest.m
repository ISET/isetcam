...
radiantExposureFig7 = figure;
clf;
set(gcf, 'Position', [770, 670, 1000, 600]);
for s = 1:length(theStimulusSizesMrad)
    ...
    if (0)
        ...
        stimulusSizeFig = figure;
        clf;
        set(gcf, 'Position', [770, 670, 1000, 1000]);
