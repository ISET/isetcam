function Hash = ieHash(Data, varargin)
% IEHASH - Checksum for Matlab array of any type
%
% Synopsis
%   Hash = ieHash(Data, Opts...)
%
% Brief description
%  Create a hash value for an input of any type. The type and
%  dimensions of the input are considered as default, such that
%  UINT8([0,0]) and UINT16(0) have different hash values. Nested
%  STRUCTs and CELLs are parsed recursively.
%
% INPUT:
...
%            Call ieHash without inputs to get a list of available methods.
%
...
%   TYPECAST, CAST.
%
% See the original function in external:  DataHash_20190519/DataHash
% for many more comments and credits.
%
