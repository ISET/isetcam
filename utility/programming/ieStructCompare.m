function [differences, common, d1, d2] = ieStructCompare(structA, structB, prefix)
...
%
%   common, d1, d2:  Outputs from comp_struct
%
% Example Usage:
%   % Assuming thisR and thisRV are your two objects (@recipe)
%   [diffs, common, diffs1, diffs2] = structCompare(thisR, thisRV);
%   disp(diffs)
%
...
% If requested, compute the differences this way, with the external method
if nargout > 1
    [common, d1, d2] = comp_struct(structA,structB);
end
