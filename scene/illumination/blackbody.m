...
%   temps    - N-vector of color temperatures
%   unitType - watts or photons  (default: watts)
%   eqWave   - Equal energy or equal photon wavelength for all
%              returned spectra
%
% Ouputs
%  specRad   - Matrix of spectral radiances at the color temperatures
%              if watts then (W/m2 nm sr).  Default luminance if just
%              one color temp is 100 cd/m2.
%  XYZ       - CIE XYZ values of the N lights in the rows (N x 3)
%
% Description
...
%
% See also
%   ieXYZFromEnergy, ieXYZFromPhotons, ieLuminanceFromEnergy
...
if ieNotDefined('wave'), error('Must define wavelength samples.'); end
...
switch lower(unitType)
    case {'watts','energy'}
        ...
        % Equate them all at the defined wavelength, eqWave
