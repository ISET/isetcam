...
% OBSOLETE: result = cmatrix(matrixtype, spacetype)
%    Use colorTransformMatrix and imageLinearTransform
%
...
if (matrixtype == 'xyz2opp' | matrixtype == 'opp2xyz') % Lum, RG, BY ???
  if (spacetype == 2)  % CIE 2 deg observer
    result = [278.7336  721.8031 -106.5520; ...
             -448.7736  289.8056   77.1569; ...
               85.9513 -589.9859  501.1089]/1000;
  end
  if (spacetype == 10) % CIE 10 deg observer
