function [k1, k2, k3] = separableFilters(sampPerDeg, dimension, filterSize)
%
...
% minSAMPPERDEG = 224;
% This makes the filter size really big.  So, we are experimenting with
% reducing timing.
minSAMPPERDEG = 112;
...
if ieNotDefined('filterSize')
    filterSize=sampPerDeg;
end;

%temp=max([filterSize, sampPerDeg]);
...
% x1 = [0.0005     1  0.225  0  7.0  0];
% x2 = [0.000685    1    0.826    0];
% x3 = [0.000920    1    0.6451    0];
