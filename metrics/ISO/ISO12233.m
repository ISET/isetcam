...
%
% Brief description
%   Slanted-edge MTF calculation using the sfrmat4 methods.  Replaces
%   ISO1223v1, which we used for many years.  Only differs slightly, but
...
%   spacing). If the value >1, the return is in units of cpd on the display
...
%   fitme -
%   esf -  Edge spread function from combining several lines
%   h - Figure handle
%   sinfo - 
%
% Notes:
...
%
% Reference
%  This code originated and has been stewarded by Peter Burns, now a
%  consultant http://burnsdigitalimaging.com/software/sfrmat/
%
%  Substantially re-written by Wandell, just for clarity.  The numerical
%  calculations have been preserved, but variable names, stray lines,
%  comments have been clarified.  Unused return variables have been
%  eliminated.  Some input options (readBarImage) that do not apply to
%  ISETCam have been removed. 
%
% See also:
%   ieISO12233, ieISO12233v1, ISOFindSlantedBar, s_metricsMTFSlantedBar
%
