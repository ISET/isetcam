...
ieNewGraphWin([], 'tall');
subplot(4, 1, 1), imagesc(x, p, psImages.source);
axis image;
subplot(4, 1, 2), imagesc(x, p, psImages.lens);
axis image;
subplot(4, 1, 3), imagesc(x, p, psImages.lensOffset);
axis image;
subplot(4, 1, 4), imagesc(x, p, psImages.detector);
axis image;
