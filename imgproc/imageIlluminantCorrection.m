...
%    3.  The ICS data are illuminant corrected (this routine)
%    4.  The illuminant corrected data are converted to sRGB
%    (displayRender)
%
...
%
% See also: imageSensorCorrection, ipCompute, displayRender
%
%
% Examples:
%
