...
ieNewGraphWin; plotSensorSNR(sensor3); drawnow;
...
ieNewGraphWin; plotSensorSNR(sensor4); drawnow;
...
ieNewGraphWin; plotSensorSNR(sensor5); drawnow;
...
% We need to add some noise (like above) to get more of the curves to be
% meaningful.  Too tired right now.
