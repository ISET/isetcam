...
%   s_sceneCreateExamples                 - Show examples of built-in scenes
%   s_sceneDataExtractionAndPlotting      - Interacting with the scene Window
...
%   s_sceneGeometryOps                    - Scene geometry operations: combine, crop, insert, resize, and resample
...
%   t_sceneIntroduction                   - Tutorial describing the scene object
%   t_sceneRGB2Radiance                   - Generate a scene from an typical image (RGB) file.
