...
% This tutorial generates ISET scenes from RGB file on different displays. It 
% also shows the three different display gamuts as well as approximate renderings 
% of the images.
% 
