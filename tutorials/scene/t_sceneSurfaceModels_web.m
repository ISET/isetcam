...
% Frequently we want to compress the spectral data. Linear models are one way 
% to achieve good approximations to the original reflectance data but use many 
% fewer numbers.
% 
% We create linear basis functions for the Gretag/Macbeth color checker surface 
% reflectance functions. This script illustrates how to
%% 
% * Read reflectances
