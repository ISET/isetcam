...
% The ray trace model includes field-height and wavelength dependent point spread 
% functions. These can either be created synthetically, or they can be derived 
% from optics software, such as Zemax. 
% 
% See also: 
% 
