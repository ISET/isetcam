...
%% 
% # A common polynominal approach. (<http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=351044 
% Shah et. al. 1994>) 
% # A hardware implementation friendly <http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=6011854&tag=1 
% coefficient method>. (<http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=6011854&tag=1 
% Blasinski et al. ICME 2011>)
%% 
